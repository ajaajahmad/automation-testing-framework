...
public class BuildCustomSeleniumMethod {
	...
	public static void main(String[] args) {
		...
		// scan the name column with getText and print the price of "Beans"
		List<String> priceList = tableElements.stream().filter(s -> s.getText().contains("Beans"))
